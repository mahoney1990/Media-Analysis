...
#Rearrange
date_dict={'2011':'0','2012':'0','2013':'0','2014':'1','2015':'2','2016':'2',
           '2017':'3','2018':'3','2019':'4','2020':'4','2021':'0'}
dates=['1','2','3','4']
for k in range(2):
    ...
    df1['Date']=[date_dict[its[0:4]] for its in df1['Date']]
    df1=df1[~df1['Date']=='0']
...
print('Writing csv....')
trigrams_df=trigrams_df.fillna(0)
trigrams_df.to_csv('Trigram_Counts_session_v1.csv')
print('Export Successful!')
